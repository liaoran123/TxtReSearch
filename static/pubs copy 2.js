...
$(function () {
  ...
  $("#searchinput").on("input", function () {    
    ...
    if (myReg.test(inval)) {   
      ...
      //$("#leftlist").find("li").remove()
      //$("#righlist").find("li").remove()
      /*
      var jlv = $("#bttext").text();
      var caid = $("#bttext").attr("data-jlv");
      var url = sev + "/api/Idxpfx/?kw=" + inval + "&caid=" + caid;
...
$(function () {
  ...
  $("#param").on("input", function () {
    ...
    var jlv = $("#bttext").text();
    var caid = $("#bttext").attr("data-jlv");
    var url = sev+"/api/idxfindpfx/?kw=" + inval + "&caid=" + caid + l;//"/getidxkey/?kw=" + inval + "&caid=" + caid + l;
    $.getJSON(url, function (data) {
      //console.log(data)
      var htmls = "";
